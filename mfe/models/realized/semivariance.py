...
class SemivarianceResult(RealizedEstimatorResult):
    ...
    def __init__(
        ...
        """Initialize the semivariance result.
        ...
        Args:
            ...
            negative_semivariance: Realized semivariance for negative returns
            threshold: Threshold used for directional classification
            jump_positive_semivariance: Realized semivariance for positive jumps
            jump_negative_semivariance: Realized semivariance for negative jumps
            continuous_positive_semivariance: Realized semivariance for positive continuous returns
            continuous_negative_semivariance: Realized semivariance for negative continuous returns
        """
        super().__init__(
        ...
        self.positive_semivariance = positive_semivariance
        self.negative_semivariance = negative_semivariance
        self.threshold = threshold
        self.jump_positive_semivariance = jump_positive_semivariance
        self.jump_negative_semivariance = jump_negative_semivariance
        self.continuous_positive_semivariance = continuous_positive_semivariance
        self.continuous_negative_semivariance = continuous_negative_semivariance
