...
class TwoScaleVarianceResult(RealizedEstimatorResult):
    ...
    def __init__(
        ...
        """Initialize the two-scale variance result.
        ...
        Args:
            ...
            slow_scale: Sampling frequency for the slow time scale
            fast_scale: Sampling frequency for the fast time scale
            slow_rv: Realized variance at the slow time scale
            fast_rv: Realized variance at the fast time scale
            bias_correction: Whether bias correction was applied
            scales_tested: List of scales tested for auto-scale selection
        ...
        self.slow_rv = slow_rv
        self.fast_rv = fast_rv
        self.bias_correction = bias_correction
        self.scales_tested = scales_tested
        self.rv_by_scale = rv_by_scale
...
TwoScaleRealizedVariance = TwoScaleVarianceEstimator
